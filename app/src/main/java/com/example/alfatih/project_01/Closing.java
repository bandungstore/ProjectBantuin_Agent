...
public class Closing extends AppCompatActivity {
    ...
    public void selesaiOnClick(View view) {
        ...
        if( spinner.getSelectedItem().toString().trim().equals("")) {
        ...
        }else if(Premi.getText().toString().trim().equals("")) {
            Premi.setError( "Harus di isi!" );
        }else if(Api.getText().toString().trim().equals("")) {
            Api.setError( "Harus di isi!" );
        }else{
            ...
            String laporan = data.insertClosing(wp.getId(), wp.getNama(), Nama.getText().toString(), Premi.getText().toString(), Api.getText().toString(), thisDate, dayOfTheWeek);

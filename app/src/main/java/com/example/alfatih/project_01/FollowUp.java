...
public class FollowUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Nama_Agent = (EditText)findViewById(R.id.nama_agen);
        ...
        try {
            ...
            solusi = new String[arrayBiodata.length()];
            ...
            for (int i = 0; i < arrayBiodata.length(); i++) {
                ...
                solusi[i] = jsonChildNode.optString("Solusi");
    ...
    public void selesaiOnClick(View view) {
        if( spinner.getSelectedItem().toString().trim().equals("")) {
        ...
        }else if(Keterangan.getText().toString().trim().equals("")) {
            ...
            String laporan = data.insertFollowUp(wp.getId(), wp.getNama(), Nama.getText().toString(), Keterangan.getText().toString(), thisDate, dayOfTheWeek);

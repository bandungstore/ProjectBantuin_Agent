...
public class JFK extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Tanggal_JFK = (EditText)findViewById(R.id.tanggal_jfk);
    ...
    public void selesaiOnClick(View view) {
        if( spinner.getSelectedItem().toString().trim().equals("")) {
            ...
            String laporan = data.insertJFK(wp.getId(), wp.getNama(), Nama.getText().toString(), thisDate, dayOfTheWeek);
